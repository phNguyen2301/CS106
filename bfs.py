...
class SnakeGame:
    ...
    def _update_ui(self):
        ...
        pygame.draw.rect(self.display, GREEN2, pygame.Rect(self.head[0]*BLOCK_SIZE, self.head[1]*BLOCK_SIZE, BLOCK_SIZE, BLOCK_SIZE))
        pygame.draw.rect(self.display, GREEN1, pygame.Rect(self.head[0]*BLOCK_SIZE+4, self.head[1]*BLOCK_SIZE+4, BLOCK_SIZE - 8, BLOCK_SIZE - 8))
